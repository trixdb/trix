# Gemini Instructions for Trix Monorepo
...
| `trix-mcp` | MCP server for AI integration |
...
Each subproject has its own GEMINI.md with specific instructions. When working in a subproject, also check its local GEMINI.md for project-specific commands and patterns.
